...
def rotation_detection_dlib(gray, rects, predictor_align):
    ...
    #rects = detector(img, 1)
        ...
        for rect in rects:
            ...
            gray = rotate_opencv(gray, nose, angle)
            h, w = gray.shape[:2]
            tx = w/2-nose[0]
            ty = h/2-nose[1]
...
def face_alignment(img, rects, predictor_align):
    img = rotation_detection_dlib(img, rects, predictor_align)
